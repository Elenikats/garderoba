      ...
      <ScrollView>
        <View style={styles.cont}>
          ...
          <View style={globalStyles.container}>
            ...
            <Text style={[globalStyles.text, { marginBottom: 14 }]}>
              Register with email
            </Text>
          </View>
          ...
          {errors &&
            errors.message &&
            errors.message.includes("username-invalid") && (
              <Text style={styles.errorMessage}>
                The username can contain only small letters, numbers and - or _.
              </Text>
            )}
          {errors &&
            errors.message &&
            errors.message.includes("duplicate key") &&
          ...
          {errors &&
            errors.message &&
            errors.message.includes("email-invalid") && (
              <Text style={styles.errorMessage}>The email is not valid.</Text>
            )}
          {errors &&
            errors.message &&
            errors.message.includes("duplicate key") &&
          ...
          {errors &&
            errors.message &&
            errors.message.includes("password-too-short") && (
              <Text style={styles.errorMessage}>
          ...
          {errors &&
            errors.message &&
            errors.message.includes("password-too-long") && (
              <Text style={styles.errorMessage}>
          ...
          {password !== repeatPassword && (
            <Text style={styles.errorMessage}>The passwords don't match.</Text>
          )}
          ...
          <Link to={{ screen: "Login" }} style={{ color: "blue" }}>
            Login
          </Link>
        </View>
      </ScrollView>
